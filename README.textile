...
Step number three is creating the sets of scenarios in a file called @ginger_scenarios.rb@, which goes in the base of your project folder. Here's an example, showing off the syntax possibilities.
